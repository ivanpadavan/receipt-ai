...
const BezierArray = typeof Float32Array === 'function' ? Float32Array : Array;
...
export function bezier(mX1: number, mY1: number, mX2: number, mY2: number): (time: number) => number {
  ...
  const sampleValues = new BezierArray(kSplineTableSize);
