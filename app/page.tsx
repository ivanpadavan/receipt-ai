          ...
          {picture.status === "idle" && (
            <Card className="p-6">
              ...
              >
                ...
                <p className="text-lg font-medium text-foreground mb-2">Upload Receipt Image</p>
                <p className="text-sm text-muted-foreground text-center">Tap to select from gallery or paste from clipboard</p>
              </div>
