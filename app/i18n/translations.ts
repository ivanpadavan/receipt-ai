...
const ru = {
  ...
  aiChatStructuralPreviewLossesTitle: "Распределения, которые могут потеряться",
  aiChatStructuralPreviewLossesText:
    "Эти распределения относятся к строкам, у которых нет точного совпадения в превью.",
  aiChatStructuralPreviewAdded: "Добавлено",
  ...
  cropReceiptImage: "Обрезать изображение чека",
  addReceiptImage: "Добавить изображение",
...
const en: Translations = {
  ...
  aiChat: "AI chat",
  aiChatPlaceholder: "Ask AI about this receipt",
  aiChatSend: "Send",
  ...
  aiChatStructuralPreviewLossesTitle: "Claims that may be lost",
  aiChatStructuralPreviewLossesText:
    "These claims belong to rows that do not have an exact match in the preview.",
  aiChatStructuralPreviewAdded: "Added",
