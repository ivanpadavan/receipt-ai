/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: f3688c0036ca4880c6dbe2b6e195958c)
// Runtime types generated with workerd@1.20251213.0 2025-12-17 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		GOOGLE_API_KEY: string;
		GOOGLE_API_MODEL: string;
		DATABASE_URL: string;
		DIRECT_URL: string;
		NEXTAUTH_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_API_KEY" | "GOOGLE_API_MODEL" | "DATABASE_URL" | "DIRECT_URL" | "NEXTAUTH_URL" | "NEXTAUTH_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "FACEBOOK_CLIENT_ID" | "FACEBOOK_CLIENT_SECRET">> {}
}
