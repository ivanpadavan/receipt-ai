...
export abstract class AbstractControl<TValue = any, TRawValue extends TValue = TValue> {
   ...
   */
  public readonly valueChanges!: Observable<TValue> & { next: (value: TValue) => void; };

  public get value$(): Observable<TValue> {
   ...
   *
   */
  public readonly statusChanges!: Observable<FormControlStatus> & { next: (value: FormControlStatus) => void; };
  ...
  /** @internal */
  _initObservables() {
    (this as Writable<this>).valueChanges = new Subject();
    (this as Writable<this>).statusChanges = new Subject();
  }
